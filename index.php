      ...
      <div class="main-wrapper">
        <?php
          if (isset($_SESSION["logedin"]) && $_SESSION['designation'] == 'Patients') {
            ...
            echo ' <button class="pay-btn" type="submit" name="pay-btn">Pay Bills</button>
            <button onclick="document.location=\'appointment.php\'" class="book-btn" type="submit" name="book-btn">Book Appointment</button>';
